function Head() {
  return (
    <div className="flex flex-col items-center justify-center gap-5 text-center font-Elza">
      <h3 className="font-elzaSemibold text-[25px] xsm:text-[32px] sm:text-[40px] xl:text-[53px] leading-7 xsm:leading-[38px] sm:leading-[42px] md:leading-[46px] xl:leading-[60px] text-center text-BoldBlack">
