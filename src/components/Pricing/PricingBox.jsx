...
function PricingBox() {
  return (
    <div className="flex xl:w-[923px] justify-between items-center font-Elza px-4 mobile:px-10 md:px-[38px] py-5 md:py-[55px] bg-gradient-to-r from-CardGradient1 to-CardGradient2 rounded-md">
      <div className="flex flex-wrap w-full gap-10 lg:gap-8 lg:justify-between lg:flex-nowrap">
