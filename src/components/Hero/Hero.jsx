...
function Hero() {
  return (
    <section className="relative w-full pt-[22px]  mobile:bg-none bg bg-no-repeat bg-bottom bg-ellipse3 flex flex-col items-center overflow-hidden">
      <div className="max-h-[381px] container ">
        <Head />
      </div>
      <div className="2xl:max-w-[1920px] w-full max-h-[482px] py-[53px] mt-1">
        <HeroSlider />
      </div>
