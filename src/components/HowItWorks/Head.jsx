function Head() {
  return (
    <div className="relative flex flex-col justify-start w-full text-center max-h-80 gap-1 sm:gap-2  md:gap-3 lg:gap-3.5 lg:items-start">
      ...
      <img src="./Images/magic-wand.png" alt="magic wand" className="absolute hidden lg:flex right-[130px] xl:right-[186px] lg:max-w-[100px] xl:max-w-[180px] max-h-[100px] xl:max-h-[150px] xl:top-0 xl:mt-[8rem] "/>
      <img src="./Images/slide.png" alt="play button" className="absolute hidden lg:flex z-1  lg:w-[245px] xl:w-[262px] max-h[157px] top-[29px] right-0"/>
    </div>
  );
}
