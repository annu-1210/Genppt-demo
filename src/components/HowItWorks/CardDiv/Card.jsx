...
function Card({card}) {
  return (
    <div className="w-[425px] flex flex-col justify-between h-[373px] rounded-lg border bg-gradient-to-r from-CardGradient1 to-CardGradient2 shadow-tooltip1 font-Elza text-wrap pt-5 pl-6 relative">
      ...
      <div className="absolute top-[150.5px] right-0 border rounded-lg ">
        <img src={card.image} alt="card-img" className="w-[399px] h-[220px]"/>
      </div>
    </div>
  );
}
